--
-- Database: `chieve`, on heroku
--

--
-- Procedures for Postgres
--
...
CREATE OR REPLACE TRIGGER update_users_updated_date BEFORE UPDATE
    ON users FOR EACH ROW EXECUTE PROCEDURE 
    update_updated_date_column();

-- To delete the trigger and function, use DROP FUNCTION nameOfFunction() CASCADE;
